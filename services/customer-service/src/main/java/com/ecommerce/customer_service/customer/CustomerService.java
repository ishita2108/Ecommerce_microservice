...
public class CustomerService {
    ...
    public void updateCustomer(CustomerRequest request) {
        var customer = repository.findById(request.id()).orElseThrow(() -> new
                CustomerNotFoundException(String.format("Cannot update Customer : No Customer Found with the provided ID :: %s!!", request.id())));
